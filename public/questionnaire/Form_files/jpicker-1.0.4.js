...
(function($)
{
        ...
        return this.each(
          function()
          {
            ...
            if ($settings.window.expandable){
              $this.after('<span id="' + id + '_jPicker_Picker" class="jPicker_Picker"><span id="' + id + '_jPicker_Color" class="jPicker_Color">&nbsp;</span><span id="' + id + '_jPicker_Icon" class="jPicker_Icon" title="Click To Open Color Picker">&nbsp;</span></span>');
              $('#form_menu').after('<span id="' + id + '_jPicker_Container" class="jPicker_Container">&nbsp;</span>');
			}
            ...
            $.extend(true, $this, // public properties, methods, and callbacks
              {
                ...
                destroy: // destroys this control entirely, removing all events and objects, and removing itself from the List
                  function()
                  {
                    if (window.expandable) colorIcon = $('#' + $this.id + '_jPicker_Icon').unbind('click', colorIconClicked);
            ...
            container = window.expandable ? $('#' + id + '_jPicker_Container') : $this;
            if (window.expandable)
              container.css( // positions must be set and display set to absolute before source code injection or IE will size the container to fit the window
                {
                  ...
                  position: 'absolute',
                  top: window.position.y == 'top' ? '100px' : window.position.y == 'center' ? '-148px' : window.position.y == 'bottom' ? '25px' : window.position.y
                });
            ...
            if (window.expandable) moveBar = $('#' + $this.id + '_jPicker_MoveBar', container).bind('mousedown', moveBarMouseDown);
  ...
  $.fn.jPicker.defaults = /* jPicker defaults - you can change anything in this section (such as the clientPath to your images) without fear of breaking the program */
      ...
      images:
        {
          clientPath: '../system/application/views/templates/lnwform/css/jPicker/images/', /* Path to image files */
          colorMap:
          {
            width: 256,
            height: 256,
